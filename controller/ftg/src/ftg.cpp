  ...
  track_width_(track_width)
{
  ...
  best_pnt_pub_ = node_->create_publisher<Marker>("/best_points/marker", 1);
  scan_pub_     = node_->create_publisher<MarkerArray>("/scan_proc/markers", 1);
  best_gap_pub_ = node_->create_publisher<MarkerArray>("/best_gap/markers", 1);
}
