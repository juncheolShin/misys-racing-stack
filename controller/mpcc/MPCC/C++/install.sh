...
mkdir -p lib
cd build
cmake .. -DCMAKE_INSTALL_PREFIX=$(realpath ../lib) -DTARGET=ARMV8A_ARM_CORTEX_A76
make
make install
...
mkdir -p lib
cd build
cmake .. -DCMAKE_INSTALL_PREFIX=$(realpath ../lib) -DBLASFEO_PATH=$(realpath ../../blasfeo/lib) -DTARGET=ARMV8A_ARM_CORTEX_A76
make
make install
