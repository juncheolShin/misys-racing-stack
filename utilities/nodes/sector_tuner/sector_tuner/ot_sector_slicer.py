...
def get_data_path(subpath=''):
    ...
    # 0916 수정
    return Path(get_package_share_directory('stack_master')).parents[3]/'stack_master'/subpath
...
class OvertakingSectorSlicer(Node):
    ...
    def __init__(self, future):
        ...
        # self.yaml_dir = "/home/misys/forza_ws/race_stack/stack_master/maps/teras/"
